...
# Warning: this is not a generic script intended for general reuse

parser = argparse.ArgumentParser('My program')
# Provide comma-separated list of parental individuals
parser.add_argument('-p1', '--mother')
parser.add_argument('-p2', '--father')
# Provide VCF containing parents and progeny
